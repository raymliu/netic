...
package com.rays.cache.cachebak;


import com.handchina.yunmart.artemis.customizedApi.cache.Cache;
import com.handchina.yunmart.artemis.customizedApi.cache.ICacheListener;
...
public class RedisCache<T> implements Cache<T>, BeanNameAware {
    ...
    private String category = "artemis:cache";
